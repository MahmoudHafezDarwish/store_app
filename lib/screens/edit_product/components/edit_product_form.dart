...
import 'package:store_app/data/firestore_files_access/firestore_files_access_service.dart';
import 'package:store_app/data/local_files_access/local_files_access_service.dart';
import 'package:store_app/local_files_handling/image_picking_exceptions.dart';
import 'package:store_app/local_files_handling/local_file_handling_exception.dart';
import 'package:store_app/models/Product.dart';
import 'package:store_app/screens/edit_product/provider_models/ProductDetails.dart';
import 'package:store_app/utile/constants.dart';
import 'package:store_app/utile/size_config.dart';
import 'package:store_app/widgets/async_progress_dialog.dart';
  ...
  Future<void> saveProductButtonCallback(BuildContext context) async {
    ...
    try {
      ...
      final productUploadFuture = newProduct
          ? MyFirebaseFireStore.myFirebaseFireStore.addUsersProduct(product)
          : MyFirebaseFireStore.myFirebaseFireStore.updateUsersProduct(product);
